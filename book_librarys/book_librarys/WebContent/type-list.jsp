	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="page-content">
				<div class="content">
					<!-- 右侧内容框架，更改从这里开始 -->
					<xblock><button class="layui-btn" onclick="member_add('添加用户','type-add.jsp','400','300')"><i class="layui-icon">&#xe608;</i>添加</button></xblock>
					<table class="layui-table">
						...
						<tbody>
							...
							<tr>
								...
								<td class="td-status">
									<span class="layui-btn layui-btn-normal layui-btn-mini">${types.tname }</span>
								</td>
								<td>
									<a title="编辑" href="javascript:;" onclick="member_edit('编辑','Type?method=type_update&tid=${types.tid }','4','400','300')" class="ml-5" style="text-decoration:none">
										<i class="layui-icon">&#xe642;</i>
									</a>
									<a title="删除" href="javascript:;" onclick="member_del('${types.tid }',this,'1')" style="text-decoration:none">
										<i class="layui-icon">&#xe640;</i>
									</a>
								</td>
							</tr>
		...
		function exit() {
			...
			function member_stop(obj, id) {
				layer.confirm('确认要停用吗？', function(index) {
					...
					$(obj).parents("tr").find(".td-status").jsp('<span class="layui-btn layui-btn-disabled layui-btn-mini">已停用</span>');
					$(obj).remove();
					layer.msg('已停用!', {
						icon: 5,
						time: 1000
			...
			/*用户-删除*/
			function member_del(tid,obj, id) {
				layer.confirm('确认要删除吗？', function(index) {
					...
					setTimeout(function(){ 
						window.location.href="Type?method=type_delete&tid="+tid;
	                    }, 800);
